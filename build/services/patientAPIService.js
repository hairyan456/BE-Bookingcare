...
var buildURLEmail = function buildURLEmail(doctorId, token) {
  var result = '';
  result = "".concat(process.env.REACT_URL, "/patient/verify-booking-appointment?token=").concat(token, "&doctorId=").concat(doctorId);
  return result;
};

// Đặt lịch mà ko cần Login (khi bấm confirm sẽ thêm thông tin ng dùng vào DB)
var postBookingAppoinment = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(inputData) {
    var user, token, booking;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          if (!(!inputData.email || !inputData.phoneNumber || !inputData.doctorId || !inputData.timeType || !inputData.date || !inputData.fullName || !inputData.gender || !inputData.address)) {
            _context.next = 3;
            break;
          }
        ...
        case 3:
          ...
          return _index["default"].User.findOrCreate({
            //trả về 1 Array, gồm 1 Object user tìm thấy và biến true or false
        ...
        case 13:
          ...
          return _index["default"].Booking.findOrCreate({
            ...
            //nếu bệnh nhân đã đặt 1 lịch trước đó, trong trạng thái 'Confirm'
            defaults: {
              statusId: 'S1',
              // S1: New, S2: Confirmed, S3: Done
        ...
        case 19:
          _context.next = 21;
          return _emailAPIService["default"].sendSimpleEmail({
        ...
        case 24:
          ...
          console.log('>>> check error from postBookingAppoinment():', _context.t0);
          return _context.abrupt("return", {
  ...
  return function postBookingAppoinment(_x) {
    return _ref.apply(this, arguments);
  };
}();
var postVerifyBookAppointment = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(doctorId, token) {
    var appointment;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 17:
          ...
          console.log('>>> check error from postVerifyBookAppointment():', _context2.t0);
          return _context2.abrupt("return", {
  ...
  return function postVerifyBookAppointment(_x2, _x3) {
