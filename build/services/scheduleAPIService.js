...
var getScheduleDoctorByDate = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(doctorId, date) {
    var dataSchedules;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 13:
          ...
          console.log('>>> check error from getScheduleDoctorByDate():', _context.t0);
          return _context.abrupt("return", {
  ...
  return function getScheduleDoctorByDate(_x, _x2) {
